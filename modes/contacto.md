...
4. **Generate message** with the 3-sentence framework adapted to the contact type:

   ### Recruiter
   - **Sentence 1 (Fit)**: Direct match criteria — role, relevant experience, availability or location
   - **Sentence 2 (Proof)**: Data point that answers their screening questions before they ask (e.g. "9 years building analytics pipelines, based in DFW, available immediately")
   ...
   - **Sentence 1 (Research)**: Reference to something specific from their work or career trajectory
