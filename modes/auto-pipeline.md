...
3. **Save in the report** as section `## Block H — Draft Application Answers`.
...
**Tone rules:**
- **Confident without arrogance**: "I've spent the past 9 years building production analytics systems — your role is where I want to apply that experience next"
...
**If any step fails**, continue with subsequent steps and mark the failed step as pending in the tracker.
