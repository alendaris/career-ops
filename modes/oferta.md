...
Classify the offer into one of the 6 archetypes (see `_shared.md`). If hybrid, list the 2 closest. This determines:
...
- Red-flag questions and how to answer them (e.g. "Why are you leaving your current role?", "Do you have direct reports?")
