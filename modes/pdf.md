...
7. Rewrite Professional Summary injecting JD keywords + exit narrative bridge ("20 years of applied analytics — now targeting [JD domain] roles where deep domain experience pairs with modern tooling.")
8. Select top 3-4 most relevant projects for the role
...
**NEVER add skills the candidate does not have. Only reformulate real experience with the exact vocabulary from the JD.**
